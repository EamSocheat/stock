    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #337ab7;color: white;">
          <h4 class="modal-title" id=""><i class="fa fa-info-circle"></i> <span data-i18nCd="lb_info">Information</span></h4>
        ...
        <div class="modal-footer">
        	<button type="button" class="btn btn-primary btn-sm" id="alertMsgOk" data-dismiss="modal"><i class="fa fa-check"></i> <span data-i18nCd="btn_ok">OK</span></button>
        </div>
      </div>
...
<!-- Modal land.comm.confirm -->
  <div class="modal fade mdl-msg" id="mdlConfirm" role="dialog"  style="overflow-y: scroll;">
    <div class="modal-dialog modal-lg">
    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header" style="background-color: #f0ad4e;color: white;">
          <h4 class="modal-title" id=""><i class="fa fa-warning"></i> <span data-i18nCd="lb_warning">Warning</span> </h4>
          <button type="button" class="close" data-dismiss="modal" id="btnExitConfirm">&times;</button>
        </div>
        <div class="modal-body">
			<!--  -->	          
        ...
        <div class="modal-footer">
        	<button type="button" class="btn btn-warning btn-sm" id="btnConfirmOk" style="color: white"><i class="fa fa-check"></i> <span data-i18nCd="btn_ok">OK</span></button>
        	<button type="button" class="btn  btn-sm" id="btnConfirmCancel" data-dismiss="modal"><i class="fa fa-times"></i> <span data-i18nCd="btn_cancl">Cancel</span></button>
        </div>
      </div>
